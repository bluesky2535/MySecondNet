...
public class MailUitls {
	...
	public static void sendMail(String to,String code){
		...
		try {
			...
			// 抄送 CC   密送BCC
			// 设置标题
			message.setSubject("来自二手开心网官方激活邮件");
			// 设置邮件正文:
			message.setContent("<h1>二手开心官方激活邮件!点下面链接完成激活操作!</h1><h3><a href='http://222.24.59.141:8080/MySecondNet/user_active?activecode="+code+"'>点击即可激活账户激活码为："+code+"</a></h3>", "text/html;charset=UTF-8");
			// 3.发送邮件:
